...
<div class="new-element">
	...
	<form action="" method="post">
		...
		<input name="self_parent_id" value="{$self_parent_id}" type="hidden">
		...
		{foreach from=$list item=rec}
			<tr>
				...
				<td>
					...
					<a title="Список дочерних элементов" href="{$rec._list_href}">
						<img alt="Список дочерних элементов" title="Список дочерних элементов" src="/rs/admin/images/ic2.gif" />
					</a>
